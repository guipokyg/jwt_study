...
import com.springboot.demo.config.jwt.JwtAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .httpBasic().disable()
        .addFilter(new JwtAuthenticationFilter(authenticationManager()))//WebSecurityConfigurerAdapter > AuthenticationManager를 파라메터로 필수로 보내줘야함.
        .addFilter(new JwtAuthorizationFilter(authenticationManager()))//WebSecurityConfigurerAdapter > AuthenticationManager를 파라메터로 필수로 보내줘야함.
        .authorizeRequests()
